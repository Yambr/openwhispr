...
// Phase 04.1 CFG-07 (Plan 02 Task 3): the Google Calendar preload exposures
// are code-generated by scripts/generate-build-config.js. When
// OAUTH_GOOGLE_ENABLED=false at build time the factory returns {} and the
// literal IPC method names are physically absent from the shipped preload
// bundle (verified by scripts/verify-oauth-gating.js#PRELOAD_TARGETS).
const buildGcalApi = require("./preload-gcal.generated.cjs");
// Phase 04.1 PLAN-03 (CFG-09 BILLING_ENABLED): Stripe billing preload exposures
// are code-generated by scripts/generate-build-config.js#emitPreloadBilling.
// When BILLING_ENABLED=false the factory returns {} and the literal IPC method
// names are physically absent from the shipped preload bundle (verified by
// scripts/verify-feature-gating.js).
const buildBillingApi = require("./preload-billing.generated.cjs");
// Phase 04.1 PLAN-04 (CFG-09 REFERRALS_ENABLED): referral preload exposures
// are code-generated by scripts/generate-build-config.js#emitPreloadReferrals.
// When REFERRALS_ENABLED=false the factory returns {} and the literal IPC
// method names are physically absent from the shipped preload bundle
// (verified by scripts/verify-feature-gating.js).
const buildReferralsApi = require("./preload-referrals.generated.cjs");
// Phase 04.1 PLAN-05 (CFG-09 STREAMING_ENABLED): AssemblyAI/Deepgram realtime
// ASR preload exposures are code-generated by
// scripts/generate-build-config.js#emitPreloadStreaming. When
// STREAMING_ENABLED=false the factory returns {} and the literal IPC method
// names are physically absent from the shipped preload bundle (verified by
// scripts/verify-feature-gating.js).
const buildStreamingApi = require("./preload-streaming.generated.cjs");
// Phase 10 PLD-05 (PROVIDER_LOCKDOWN_ENABLED): BYOK + enterprise key preload
// exposures are code-generated by scripts/generate-build-config.js#emitPreloadByok.
// When PROVIDER_LOCKDOWN_ENABLED=true the factory returns {} and the literal
// IPC method names are physically absent from the shipped preload bundle
// (verified by scripts/verify-feature-gating.js).
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  // BYOK provider keys (getOpenAIKey/saveOpenAIKey and all other BYOK +
  // enterprise key methods) are code-generated and gated by
  // PROVIDER_LOCKDOWN_ENABLED — see buildByokApi spread below.
  ...
  // Anthropic / Gemini / Groq / Mistral / Custom BYOK keys + enterprise key
  // methods are code-generated and gated by PROVIDER_LOCKDOWN_ENABLED — see
  // buildByokApi spread below.
  ...
  // Gemini / Groq / Mistral / Custom BYOK keys + Bedrock/Azure/Vertex
  // enterprise key management are code-generated and gated by
  // PROVIDER_LOCKDOWN_ENABLED — see buildByokApi spread below.
  ...
  // Enterprise reasoning (Bedrock, Azure, Vertex) — code-generated and gated
  // by PROVIDER_LOCKDOWN_ENABLED — see buildByokApi spread below. Runs in the
  // main process so Node-only SDKs (AWS/Azure/Google) can resolve.
  ...
  // Stripe billing — code-generated, gated by BILLING_ENABLED at build time.
  // See scripts/generate-build-config.js#emitPreloadBilling.
  ...
  // Referrals — code-generated, gated by REFERRALS_ENABLED at build time.
  // See scripts/generate-build-config.js#emitPreloadReferrals.
  ...buildReferralsApi(ipcRenderer),

  // AssemblyAI + Deepgram realtime ASR — code-generated, gated by
  // STREAMING_ENABLED at build time. See
  // scripts/generate-build-config.js#emitPreloadStreaming.
  ...buildStreamingApi(ipcRenderer, registerListener),

  // BYOK + enterprise key management — code-generated, gated by
  // PROVIDER_LOCKDOWN_ENABLED at build time. Returns {} under lockdown.
  // See scripts/generate-build-config.js#emitPreloadByok.
  ...
  // Google Calendar — code-generated, gated by OAUTH_GOOGLE_ENABLED at
  // build time. See scripts/generate-build-config.js#emitPreloadGcal.
  ...
  // (Google Calendar event listeners are spread in via buildGcalApi above.)
